            ...
            <div class="form-container">
                ...
                <form action="{{ route('update', $data->id) }}" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="employee_id" name="employee_id" value="{{$data->employee_id}}" placeholder="Enter your ID" required>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="mobile" name="phone"  value="{{$data->phone}}" placeholder="Enter your phone number" required>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="salary" name="salaray"  value="{{$data->salary}}" placeholder="Enter your salary" required>
                    </div>
